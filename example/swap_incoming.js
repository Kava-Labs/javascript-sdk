...
var incomingSwap = async () => {
  ...
  const senderOtherChain = Env.KavaDeputy.Testnet6000Internal; // deputy's address on Kava
  const recipientOtherChain = Env.KavaAccount.Testnet6000Internal.Address; // user's address on Kava
